"""
Run inference on eval/test_cases.json using Round 1 LoRA model.
Results are written back to model_output fields in the same file.
"""
...
LORA_PATH  = "/workspace/models/round1_lora"
...
def parse_output(raw: str) -> dict:
    """Extract JSON from model output; return empty structure on failure."""
...
def main():
    ...
    for case in cases:
        ...
        case["model_output"] = parse_output(raw_output)
